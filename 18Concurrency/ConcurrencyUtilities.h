#ifndef CONCURRENCY_UTILITIES
#define CONCURRENCY_UTILITIES
...
{
public:
    ElapsedTimeRecorder(const std::string& str) : name(str), begin(std::chrono::high_resolution_clock::now()), last(begin)
    {
    }
    ~ElapsedTimeRecorder()
    {
